...
def banner():
    print("\n%s    _________ __     \n%s   / ____/ (_) /____  ║ %sDesign By %sHAMAYUN %s& %sKHAN\n%s  / __/ / / / __/ _ \ ║ %sFB %s: %sFacebook.com/hamayun Khan\n%s / / / / / / /  / ║ %sFB %s: %sFacebook.com/HAmaYUN\n%s/_____/_/_/\__/\___/  ║ %sGithub %s: %sGithub.com/hamayun01\n"%(O,O,P,O,P,O,O,P,O,P,O,P,O,P,O,P,O,P))
def menu_log():
...
def var_author():
    ...
    mlaku('%s║     • %shamayun'%(O,P))
    mlaku('%s║     • %skhan'%(O,P))
    mlaku('%s║'%(O))
    mlaku('%s╠══[%s•%s] %sTeam Project %sXNSCODE%s :'%(O,P,O,P,O,P))
    mlaku('%s║     • %sHAMAYUN KHAN'%(O,P))
    mlaku('%s║     • %sUBAID ULLAH'%(O,P))
    mlaku('%s║     • %sWAQAS KHAN'%(O,P))
    mlaku('%s║     • %sIHTISHAM '%(O,P))
    mlaku('%s║     • %sABBAS'%(O,P))
    mlaku('%s║     • %sAHMAD ALI'%(O,P))
    mlaku('%s║     • %sHASSAN '%(O,P))
    mlaku('%s║     • %sWAQAR'%(O,P))
    mlaku('%s║     • %sAHMADO'%(O,P))
    mlaku('%s║     • %sAFRIDI KH'%(O,P))
    mlaku('%s║     • %sHARIS'%(O,P))
    mlaku('%s║     • %sWAQAS AHMED'%(O,P))
    mlaku('%s║'%(O))
def var_ugen():
